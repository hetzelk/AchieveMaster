...
namespace AchieveMaster.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Rating,UserID,Review")] Reviews reviews)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Rating,UserID,Review")] Reviews reviews)
        {
            if (ModelState.IsValid)
            {
